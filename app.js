...
mainEle.addEventListener('submit', FormMethod);
function FormMethod(e) {
  ...
  if (flagStopSubmit) {
    ...
    document.getElementById('hid1').style.display = 'grid';
...
function DeleteForm() {
  if (counter === 7) {
    flagStopSubmit = true;
    console.log(flagStopSubmit, counter);
  }
  else {

    flagStopSubmit = false;
    console.log(flagStopSubmit, counter);
...
function validateFormNumber(testNumber, id) {
  console.log(testNumber, testNumber.length);
